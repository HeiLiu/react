...
export default class extends Component {
  ...
  init(coords) {
    ...
    this.loadPoiData(coords)  // 加载热点地区
  ...
  loadTypeData({ latitude, longitude }) {
    ...
    fetch(`/restapi/shopping/openapi/entries?latitude=${latitude}
    &longitude=${longitude}&templates[]=main_template&templates[]=favourable_template&templates[]=svip_template`)
      .then(res => {
        if (res.status === 200) {
          res.json().then(data => {
            this.setState({
